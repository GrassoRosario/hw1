...
<head>
    ...
    <title>Wiki-WWF</title>
    <link rel="icon" type="image/png" href="immagini/Emblem-WWF.jpg">

    <link rel="stylesheet" href="mhw3.css" />
    <link rel="stylesheet" href="mhw3-Page2.css" />

    <script src="mhw3.js" defer></script>
    <script src="mhw3-Page2.js" defer></script>
...
<body>
    ...
    <header>
        ...
        <section id="corpo_header">
            <p><strong> <a>WWF SOSTIENI</a> > <a href="mhw3.php">ADOZIONI</a> > WIKI </strong></p>
    ...
    <section id="ricerca">
        <h1>Informazioni sulle specie a rischio</h1>
        <form>
            Inserisci il nome di un animale
            <input type='text' id='pet'>
            <input type='submit' id='submit' value='Cerca' name="search">
            <select>
                <option>Panda (ailuropoda melanoleuca)</option>
                <option>Koala (Phascolarctos cinereus)</option>
                <option>Foca (Phocidae)</option>
                <option>Orango (Pongo pygmaeus)</option>
                <option>Orso bruno (Ursus arctos)</option>
            </select>
        </form>

        <section id="pet-article-view">
        </section>
    </section>

    <section id="fondo">
        <h1><strong>Pi� forti, con te al nostro fianco.</strong></h1>
        <span>
            ...
            ci sar� la tua scelta di agire, di stare in prima linea nella battaglia per la protezione degli animali a rischio e della Natura
        </span>
    </section>
        ...
        <div class="footer_sezione">
            <div id="Come_usiamo_i_fondi_raccolti">
                ...
                <div>
                    ...
                    <a>Scopri di pi�</a><br /><br />
                    <div class="righe-grafico"> <span class="Blocco verde"> 73% </span> <span> Attivit� di programma</span></div><br />
                    <div class="righe-grafico"> <span class="Blocco arancione"> 22% </span> <span> Attivit� di raccolta fondi</span></div><br />
                    <div class="righe-grafico"> <span class="Blocco grigio"> 2% </span> <span> Attivit� di supporto generale</span></div><br />
