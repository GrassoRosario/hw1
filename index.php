    ...
    <header>
        ...
        <nav>
            ...
            <div id="dropbox">
                ...
                <div id="dropbox-hidden" class="hidden" >
                    ...
                    <a class="dropbox-items" href="signup.php">
                        <span> REGISTRATI</span>  <span class="material-symbols-outlined">app_registration</span>
                    </a>

                    <a class="dropbox-items" href="login.php">
                        <span> ACCEDI</span>  <span class="material-symbols-outlined">login</span>
                    </a>
        ...
        <section id="corpo_header">
            ...
            <div>
                ...
                <p>Oggi c'è una nuova specie in pericolo: la nostra. Con il tuo <br>
                5x1000 al WWF cambiamo il nostro futuro. Proteggendo la <br>
                natura.</p>

                <a><strong>SCOPRI COME</strong></a>
