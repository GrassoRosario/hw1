...
<html>
<head>
    <title>Pagina-Profilo-WWF</title>
...
<BODY>
    <header>
        ...
        <section id="corpo_header">
            <p><strong> <a>WWF SOSTIENI</a> > <a href="mhw3.php">ADOZIONI</a> > PROFILO: <?php echo $_SESSION["username"] ?></strong></p>

            <h1>LOTTIAMO PER LA<br> NATURA E PER OGNI<br> SINGOLA SPECIE CHE LA<br> ABITA</h1>

            <p>
                Dal 1966, difendiamo l'ambiente e le specie a rischio.
            </p>
        </section>
    </header>
